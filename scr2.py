...
if __name__ == "__main__":
    ...
    while start_time < max_time:
        ...
        for subreddit in sub_queries:
            ...
            curr_url = base_POST_url.format(KEYWORD, subreddit, start_time, end_time)
            try:
    ...
    fname1 = "./{}-sentiment-post14-20.csv".format(KEYWORD)
    ...
    fname2 = "./{}-count-post14-20.csv".format(KEYWORD)
...
df1 = pd.read_csv('/content/bitcoin-sentiment-post14-20.csv')
df2 = pd.read_csv('/content/bitcoin-count-post14-20.csv')
